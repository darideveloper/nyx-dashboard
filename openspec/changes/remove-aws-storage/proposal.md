...
- Delete custom AWS storage backend implementations in `project/storage_backends.py`.
- Consolidate storage configuration in `project/settings.py` to always use the local filesystem.
