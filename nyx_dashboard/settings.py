...
AFFILIATES_DISCOUNT = float(os.getenv("AFFILIATES_DISCOUNT") or 0.0)
AFFILIATES_COMMISSION = float(os.getenv("AFFILIATES_COMMISSION") or 0.0)
INVOICE_IGI_COMMISSION = float(os.getenv("INVOICE_IGI_COMMISSION") or 0.0)
INVOICE_PAYPAL_COMMISSION = float(os.getenv("INVOICE_PAYPAL_COMMISSION") or 0.0)
INVOICE_STRIPE_COMMISSION = float(os.getenv("INVOICE_STRIPE_COMMISSION") or 0.0)
