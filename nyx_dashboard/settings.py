...
AFFILIATES_DISCOUNT = float(os.getenv("AFFILIATES_DISCOUNT", 0.0))
AFFILIATES_COMMISSION = float(os.getenv("AFFILIATES_COMMISSION", 0.0))
...
INVOICE_STRIPE_COMMISSION = float(os.getenv("INVOICE_STRIPE_COMMISSION", 0.0))
